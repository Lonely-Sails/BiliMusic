<template>
  ...
  <div class="playlist-view">
    <div class="playlist-header">
      <h2>
        <Icon icon="mdi:playlist-music" class="section-icon" />
        播放列表
      </h2>
      <div class="playlist-actions" v-if="player.playlist.length > 0">
    ...
    <div v-if="player.playlist.length === 0" class="empty-playlist">
...
export default {
  ...
  setup() {
    ...
    return { player, user, formatDuration }
  }
}
</script>
